...
function Install_dependencies()
    ...
    local libs = {
        ...
        { url = "https://github.com/OUIsolutions/BearHttpsClient/releases/download/0.9.1/BearHttpsClient.h", path = "dependencies/BearHttpsClient.h" },
        { url = "https://github.com/OUIsolutions/BearHttpsClient/releases/download/0.9.1/BearHttpsClient.c", path = "dependencies/BearHttpsClient.c" },
        ...
        {url="https://github.com/OUIsolutions/CWebStudio/releases/download/5.0.0/CWebStudio.h", path = "dependencies/CWebStudio.h"},
        {url="https://github.com/OUIsolutions/CWebStudio/releases/download/5.0.0/CWebStudio.c", path = "dependencies/CWebStudio.c"},
