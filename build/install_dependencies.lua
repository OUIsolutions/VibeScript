...
function Install_dependencies()
    ...
    local libs = {
        ...
        { url = "https://github.com/OUIsolutions/BearHttpsClient/releases/download/0.9.0/BearHttpsClient.h", path = "dependencies/BearHttpsClient.h" },
        { url = "https://github.com/OUIsolutions/BearHttpsClient/releases/download/0.9.0/BearHttpsClient.c", path = "dependencies/BearHttpsClient.c" },
