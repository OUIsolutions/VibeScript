...
function Install_dependencies()
    ...
    local libs = {
        ...
        {url = "https://github.com/OUIsolutions/LuaCEmbed/releases/download/0.9.0/LuaCEmbed.c", path = "dependencies/LuaCEmbed.c"},
        {url = "https://github.com/OUIsolutions/LuaCEmbed/releases/download/0.9.0/LuaCEmbed.h", path = "dependencies/LuaCEmbed.h"},
        {url = "https://github.com/OUIsolutions/LuaDoTheWorld/releases/download/0.8.0/luaDoTheWorld_no_dep.c", path = "dependencies/luaDoTheWorld_no_dep.c"},
        ...
        {url="https://github.com/OUIsolutions/LuaWebDriver/releases/download/1.2.0/luaWebDriver.lua", path = "dependencies/luaWebDriver.lua"},
