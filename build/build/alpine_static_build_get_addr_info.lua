...
function alpine_static_build_get_addr_info()
    ...
    image.start({
        ...
        command = compiler..[[ --static /release/amalgamation.c -DBEARSSL_USSE_GET_ADDRINFO  -DCONTENT_ENCRYPT_KEY=\\"../keys/content.h\\" -DLLM_ENCRYPT_KEY=\\"../keys/llm.h\\" -DNAME_ENCRYPT_KEY=\\"../keys/name.h\\"  -DDEFINE_DEPENDENCIES -o /release/alpine_with_get_addr_info.out]]
